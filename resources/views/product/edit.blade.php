            ...
            <div class="bg-white rounded-lg shadow-sm p-4">
                <div class="flex items-center mb-3">
                    <div class="basis-5/12">
                        <h2 class="text-lg font-semibold mb-2">Cập nhật sản phẩm</h2>
                    </div>
                ...
                <div class="flex gap-5">
                    <div class="basis-9/12">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="content" rows="7" type="text" class="border p-2 w-full rounded-md mb-t">{{ old('content', $product->content) }}</textarea>
                            @error('content')
                                <div class="text-red-500">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="basis-3/12">
                        ...
                        <div class="mb-4">
                            ...
                            <input name="price_discount" value="{{ old('price_discount', $product->price_discount) }}"
                                type="number" class="border p-2 w-full rounded-md mb-t">
                            @error('price_discount')
                                <div class="text-red-500">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="flex justify-center">
                            <img src="{{ Storage::url($product->image_url) }}" alt="{{ $product->name }}" class="w-1/2"
                                id="showimage">
                        </div>
                        <div class="mb-4">
                            <label for="">Hình đại diện</label>
                            <input type="file" name="image_url" id="image_url" class="border p-2 w-full rounded-md mb-t"
